        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed">
              Visão AIOS: A próxima geração de softwares, onde a inteligência artificial não é uma ferramenta, mas a própria plataforma para inovação, adaptabilidade e crescimento contínuo.
            </p>
          </motion.div>
          <motion.div 
          ...
          >
            <img 
              src="https://storage.googleapis.com/aurora-homepage-assets-prod1/Otimizadas%20Web/13.webp"
              alt="Visão AIOS Aurora"
