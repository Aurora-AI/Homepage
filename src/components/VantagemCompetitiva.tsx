      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <motion.div variants={itemVariants}>
          <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-6">
            Descubra Nossa Vantagem Competitiva
          </h2>
          <p className="text-lg md:text-xl text-slate-300 leading-relaxed">
            Nossas soluções transformam desafios em oportunidades, com insights preditivos e eficiência incomparável. Vamos além do que é comum, fornecendo uma base sólida para o seu crescimento.
          </p>
        </motion.div>
        <motion.div variants={itemVariants}>
          <img src={imageUrl} alt="Vantagem Competitiva Aurora" 
